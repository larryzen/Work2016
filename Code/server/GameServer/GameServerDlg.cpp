...
//构造函数
CGameServerDlg::CGameServerDlg() : CDialog(IDD_GAME_SERVER_DIALOG)
{
}
...
//创建房间
void CGameServerDlg::OnBnClickedCreate()
{
	//获取目录
...
//配置房间
void CGameServerDlg::OnBnClickedOption()
{
...
//系统配置
void CGameServerDlg::OnBnClickedSystem()
{
...
//保存配置
void CGameServerDlg::OnBnClickedSaveOption()
{
	//获取目录
	TCHAR szPath[MAX_PATH]=TEXT("");
	GetCurrentDirectory(sizeof(szPath),szPath);
...
const tagDBConnectInfo * CGameServerDlg::GetDBConnectInfo(DWORD dwDataBaseAddr)
{
	//寻找现存
