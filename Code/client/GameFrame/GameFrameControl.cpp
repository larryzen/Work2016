...
BOOL CGameFrameControl::OnInitDialog()
{
	...
	m_BrowerAD.Navigate(TEXT("http://127.0.0.1/AD/GameFrameAD.asp"),NULL,NULL,NULL,NULL);
...
{
	TCHAR szRuleUrl[128];
	_snprintf(szRuleUrl,sizeof(szRuleUrl),TEXT("http://127.0.0.1/GameRule.asp?KindID=%ld"),m_UserListView.m_wKindID);
