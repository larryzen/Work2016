...
BOOL CDlgRegister::OnInitDialog()
{
	...
	m_LineRegWeb.SetHyperLinkUrl(TEXT("http://127.0.0.1"));
	m_LineMainPage.SetHyperLinkUrl(TEXT("http://127.0.0.1"));
	m_LinePassWord.SetHyperLinkUrl(TEXT("http://127.0.0.1"));
...
BOOL CDlgLogon::OnInitDialog()
{
	...
	m_BrowerAD.Navigate(TEXT("http://127.0.0.1/AD/LogonAD.asp"),NULL,NULL,NULL,NULL);
	...
	//设置控件
	m_LineMainPage.SetHyperLinkUrl(TEXT("http://127.0.0.1"));
	m_LinePassWord.SetHyperLinkUrl(TEXT("http://127.0.0.1/Passwordprotection.asp"));
	m_LineGetPassWord.SetHyperLinkUrl(TEXT("http://127.0.0.1/FindPassWord.asp"));
...
{
//#ifndef _DEBUG
//	ShellExecute(NULL,TEXT("open"),TEXT("http://127.0.0.1/service/viewrule.jsp"),NULL,NULL,SW_SHOWDEFAULT);
//	return;
//#endif
